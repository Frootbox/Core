...
namespace Frootbox\Ext\Core\Images\Plugins\Interferer\Admin\Entity;
    ...
    ): Response
    {
        ...
        return self::getResponse('json', 200, [
            'replace' => [
                ...
                'html' => $gp->injectPartial(\Frootbox\Ext\Core\Images\Plugins\Interferer\Admin\Property\Partials\ListEntities::class, [
                    'plugin' => $this->plugin,

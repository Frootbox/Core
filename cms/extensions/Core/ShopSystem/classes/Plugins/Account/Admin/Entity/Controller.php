...
namespace Frootbox\Ext\Core\ShopSystem\Plugins\Account\Admin\Entity;
...
class Controller extends \Frootbox\Admin\AbstractPluginController
{
    ...
    public function ajaxCreateAction(
        ...
        \Frootbox\Ext\Core\ShopSystem\Plugins\Account\Persistence\Repositories\Entities $entitiesRepository,
    ...
    ): Response
    {
        ...
        foreach ($titles as $title) {
            ...
            // Insert new property
            $entity = $entitiesRepository->insert(new \Frootbox\Ext\PixelFabrikExt\RealEstateBroker\Persistence\Property([
        ...
        return self::getResponse('json', 200, [
            'replace' => [
                ...
                'html' => $gp->injectPartial(\Frootbox\Ext\Core\ShopSystem\Plugins\Account\Admin\Property\Partials\ListEntities::class, [
                    'plugin' => $this->plugin,

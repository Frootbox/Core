...
namespace Frootbox\Ext\Core\ShopSystem\Plugins\CouponGenerator\Admin\Entity;
...
class Controller extends \Frootbox\Admin\AbstractPluginController
{
    ...
    public function ajaxCreateAction(
        ...
        \Frootbox\Ext\Core\ShopSystem\Plugins\CouponGenerator\Persistence\Repositories\Entities $entitiesRepository,
    ...
    ): Response
    {
        ...
        return self::getResponse('json', 200, [
            'replace' => [
                ...
                'html' => $gp->injectPartial(\Frootbox\Ext\Core\ShopSystem\Plugins\CouponGenerator\Admin\Property\Partials\ListEntities::class, [
                    'plugin' => $this->plugin,

...
namespace Frootbox\Ext\Core\System\Plugins\Logout\Admin\Entity;
...
class Controller extends \Frootbox\Admin\AbstractPluginController
{
    ...
    public function ajaxCreateAction(
        ...
        \Frootbox\Ext\Core\System\Plugins\Logout\Persistence\Repositories\Entities $entitiesRepository,
    ...
    ): Response
    {
        ...
        foreach ($titles as $title) {
            ...
            // Insert new entity
            $entity = $entitiesRepository->insert(new \Frootbox\Ext\Core\System\Persistence\Entity([
        ...
        return self::getResponse('json', 200, [
            'replace' => [
                ...
                'html' => $gp->injectPartial(\Frootbox\Ext\Core\System\Plugins\Logout\Admin\Property\Partials\ListEntities::class, [
                    'plugin' => $this->plugin,
